...
import com.vcom.bean.DeliveryCompany;
import com.vcom.repository.DeliveryCompanyRepository;
...
public class DeliveryCompanyService {
    ...
    @Transactional
    public Flux<DeliveryCompany> save(List<DeliveryCompany> companys) {
        Flux<DeliveryCompany> result = Flux.just();
        for (DeliveryCompany company : companys) {
            result = result.concat(result, repository.save(company));
        }
        return result;
    }
